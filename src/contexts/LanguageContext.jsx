...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = useMemo(() => ({
    en: {
      ...
      step_order_placed_desc: 'Your order has been received',
      step_confirmed: 'Confirmed',
      step_confirmed_desc: 'Order confirmed by seller',
      step_processing: 'Processing',
      step_processing_desc: 'Preparing your order',
      step_shipped: 'Shipped',
      step_shipped_desc: 'Handed over to courier',
      step_out_for_delivery: 'Out for Delivery',
      step_out_for_delivery_desc: 'On the way to you',
      step_delivered: 'Delivered',
      step_delivered_desc: 'Delivered successfully',
      in_progress: 'In Progress',
      whats_next: "What's Next?",
      whats_next_0: "Your order is being reviewed. You'll receive a confirmation shortly.",
      whats_next_1: "Your order is confirmed and will be prepared for shipping soon.",
      whats_next_2: "Your order is being prepared. It will be handed over to the courier soon.",
      whats_next_3: "Your order is on its way! Track it on the courier website for real-time updates.",
      whats_next_4: "Your order is out for delivery today. Please keep your phone handy.",
      order_timeline: 'Order Timeline',
      timeline_order_placed: 'Order Placed',
      timeline_processing: 'Processing Started',
      timeline_shipped: 'Shipped to Courier',
      ...
      unable_to_track: 'Unable to track this order',
    },
    bn: {
      // Navigation
      home: 'হোম',
      ...
      step_order_placed: 'অর্ডার দেওয়া হয়েছে',
      step_order_placed_desc: 'আপনার অর্ডার গৃহীত হয়েছে',
      step_confirmed: 'নিশ্চিত',
      step_confirmed_desc: 'বিক্রেতা অর্ডার নিশ্চিত করেছেন',
      step_processing: 'প্রক্রিয়াকরণ',
      step_processing_desc: 'আপনার অর্ডার প্রস্তুত করা হচ্ছে',
      step_shipped: 'পাঠানো হয়েছে',
      step_shipped_desc: 'কুরিয়ারকে দেওয়া হয়েছে',
      step_out_for_delivery: 'ডেলিভারির পথে',
      step_out_for_delivery_desc: 'আপনার কাছে আসছে',
      step_delivered: 'ডেলিভারি সম্পন্ন',
      step_delivered_desc: 'সফলভাবে ডেলিভারি হয়েছে',
      in_progress: 'চলমান',
      whats_next: 'এরপর কী হবে?',
      whats_next_0: 'আপনার অর্ডার পর্যালোচনা করা হচ্ছে। শীঘ্রই নিশ্চিতকরণ পাবেন।',
      whats_next_1: 'আপনার অর্ডার নিশ্চিত হয়েছে এবং শীঘ্রই শিপিংয়ের জন্য প্রস্তুত করা হবে।',
      whats_next_2: 'আপনার অর্ডার প্রস্তুত করা হচ্ছে। শীঘ্রই কুরিয়ারকে দেওয়া হবে।',
      whats_next_3: 'আপনার অর্ডার পথে আছে! রিয়েল-টাইম আপডেটের জন্য কুরিয়ার ওয়েবসাইটে ট্র্যাক করুন।',
      whats_next_4: 'আজ আপনার অর্ডার ডেলিভারির জন্য বের হয়েছে। অনুগ্রহ করে আপনার ফোন হাতের কাছে রাখুন।',
      order_timeline: 'অর্ডার টাইমলাইন',
      timeline_order_placed: 'অর্ডার দেওয়া হয়েছে',
      timeline_processing: 'প্রক্রিয়াকরণ শুরু হয়েছে',
      timeline_shipped: 'কুরিয়ারকে পাঠানো হয়েছে',
      timeline_delivered: 'ডেলিভারি সম্পন্ন',
      downloading: 'ডাউনলোড হচ্ছে...',
      invoice_downloaded: 'ইনভয়েস সফলভাবে ডাউনলোড হয়েছে',
      invoice_download_failed: 'ইনভয়েস ডাউনলোড করতে ব্যর্থ। আবার চেষ্টা করুন।',
      cash_on_delivery: 'ক্যাশ অন ডেলিভারি',
      thank_you_review: 'আপনার রিভিউর জন্য ধন্যবাদ!',
      unable_to_track: 'এই অর্ডার ট্র্যাক করা যাচ্ছে না',
    }
  }), []);
